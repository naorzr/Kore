...
function PWABadge() {
  ...
  // You can remove the onRegisteredSW callback and registerPeriodicSync function if not needed.
  const period = 0;
  ...
  function close() {
    // Don't remove the typeof check: see https://github.com/vite-pwa/vite-plugin-pwa/issues/712
